...
export function Modal({
  ...
  return (
    ...
    >
      ...
      <div className={`relative w-full max-w-md overflow-hidden rounded-2xl border border-emerald-300/25 bg-black/70 text-emerald-50 ${SHADOWS.modal} backdrop-blur`}>
